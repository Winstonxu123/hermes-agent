...
def _desk_agent_kwargs(
    session_id: str,
    project: Optional[Dict[str, Any]],
    body: DeskSessionCreate | None = None,
) -> Dict[str, Any]:
    ...
    model = (
        (body.model if body and body.model else None)
        or (project or {}).get("default_model")
        or _resolve_gateway_model(config)
    )
        ...
        def _run_sync():
            ...
            try:
                ...
                with _DESK_ENV_LOCK:
                    ...
                    runtime_kwargs = _desk_agent_kwargs(body.session_id, _find_project(model_config.get("project_id")))["runtime_kwargs"]
                    agent = AIAgent(
                        model=model,
                        **runtime_kwargs,
